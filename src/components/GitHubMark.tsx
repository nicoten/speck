/** GitHub's own mark, so a link to a repository is recognisable at a glance. */
export function GitHubMark() {
  return (
    <svg
      className="ghmark"
      viewBox="0 0 16 16"
      /* Sized in em, so the mark tracks the label’s font size rather than
         needing a pixel value kept in step by hand. */
      width="1em"
      height="1em"
      aria-hidden="true"
      fill="currentColor"
